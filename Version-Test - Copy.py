...
class main:
    ...
    def display_changes(self, scr, dst):
        ...
        for i in range(table_len):
            try:
                ...
                scr_side = "      |X|XXXXXX|XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
            ...
            try:
                ...
                color = "red"
                x = "-"
            self.print("      |"+x+scr_side+"|"+dst_side+"|", color)
        self.print("      +-+------+--------------------------------------------+--------------------------------------------+","white")
    ...
    def save_log(self):
        ...
        file.write("        <style>\n")
        file.write("            body{\n")
        file.write("                background-color: #303030;\n")
        ...
        for line in self.log:
            text = line[0]
            color = line[1]
            text = text.replace("<","&nbsp").replace(">","&nbsp").replace("\n","<br>").replace(" ","&nbsp").replace("\t","&nbsp")
